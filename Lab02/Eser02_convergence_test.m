function [errors_table,rates]=Eser02_convergence_test(test_name)
...
for k=1:num_test
    ...
    [errors,solutions,femregion,Dati] = Eser02_main1D(test_name,refinement_vector(k));
