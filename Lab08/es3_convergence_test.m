function [errors_table,rates]=es3_convergence_test(test_name)
...
for k=1:num_test
    ...
    [errors,solutions,femregion,Dati] = es3_main1D(test_name,refinement_vector(k));
